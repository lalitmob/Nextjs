    ...
    <div className="w-full border border-b-1 h-[60px] px-[10%]">
      <div className="w-full flex  justify-between items-center h-full ">
        ...
        <div className="flex items-center gap-2">
          <button className="font-bold hover:border hover:rounded-2xl px-4 py-2 text-blue-500  hover:bg-blue-500 hover:text-white-1 hover:shadow-lg transition-all duration-300 ">Logout</button>
